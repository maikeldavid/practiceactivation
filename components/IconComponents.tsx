...
// This file has been completely rebuilt to fix malformed and incomplete SVG data.

import logo from '../assets/logo.png';

// Custom Logo
export const Logo = (props: React.ImgHTMLAttributes<HTMLImageElement>) => (
    <img src={logo} alt="Itera Health" {...props} />
);


// Standard Icons (from Lucide set, corrected and verified)
...
export const BookUserIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /><circle cx="12" cy="10" r="2" /><path d="M18 18.5c-3.33-1-5-3-5-4.5V12" /></svg>
);
...
export const CalendarClockIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5" /><path d="M16 2v4" /><path d="M8 2v4" /><path d="M3 10h18" /><circle cx="18" cy="18" r="4" /><path d="M18 16.5v1.5l.5.5" /></svg>
);
...
export const CheckedCheckboxIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const DoctorIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const HandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.5a2.5 2.5 0 0 1 5 0V17" /><path d="M13 17a2 2 0 0 0 2 2h5a2 2 0 0 0 2-2V9.5a2.5 2.5 0 0 0-5 0V17" /><path d="M12 7.5c-2 0-5 .5-5 2.5V17" /><path d="M12 7.5c2 0 5 .5 5 2.5V17" /></svg>
);
...
export const HeartPulseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" /><path d="M3.22 12H9.5l.7-1 2.12 5.14.7-1H20.8" /></svg>
);
...
export const HeadsetIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5Zm0 0a9 9 0 1 1 18 0v5a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3Z" /></svg>
);
...
export const Laptop = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55A1 1 0 0 1 20.28 20H3.72a1 1 0 0 1-.98-1.45L4 16" /></svg>
);
...
export const LayoutList = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="7" height="7" x="3" y="3" rx="1" /><rect width="7" height="7" x="3" y="14" rx="1" /><path d="M14 4h7" /><path d="M14 9h7" /><path d="M14 15h7" /><path d="M14 20h7" /></svg>
);
export const LinkedInIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
);
...
export const PhoneCall = (props: React.SVGProps<SVGSVGElement>) => (
...
export const PlayIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
);
...
export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 3L13.82 10.18L21 12L13.82 13.82L12 21L10.18 13.82L3 12L10.18 10.18L12 3Z" />
        <path d="M3 3h.01" />
        <path d="M21 3h.01" />
        <path d="M21 21h.01" />
        <path d="M3 21h.01" />
...
export const StethoscopeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.8 2.3A.3.3 0 1 0 5 2a.3.3 0 0 0-.2.3V5a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V9a2 2 0 0 1 2-2h1a2 2 0 0 0 2-2V2.3a.3.3 0 1 0-.5 0V5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5V2.3a.3.3 0 1 0-.5 0V5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5V2.3a.3.3 0 1 0-.5 0V5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5V2.3a.3.3 0 1 0-.5 0V5a.5.5 0 0 1-.5.5H7a.5.5 0 0 1-.5-.5V2.3Z" /><path d="M8 11v1a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-1" /><circle cx="12" cy="18" r="2" /></svg>
);
...
export const ThumbsUpIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 10v12" /><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h1a2 2 0 0 1 1.92 1.44l1.4 3.44Z" /></svg>
);
...
export const Users2 = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 19a6 6 0 0 0-12 0" /><circle cx="8" cy="10" r="4" /><circle cx="18" cy="10" r="4" /><path d="M18 19a6 6 0 0 0-10-4.47" /></svg>
);
...
export const YouTubeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M21.582,6.186 C21.347,5.394 20.767,4.814 19.976,4.578 C18.59,4.25 12,4.25 12,4.25 C12,4.25 5.41,4.25 4.024,4.578 C3.233,4.814 2.653,5.394 2.418,6.186 C2.083,7.572 2.083,12 2.083,12 C2.083,12 2.083,16.428 2.418,17.814 C2.653,18.606 3.233,19.186 4.024,19.422 C5.41,19.75 12,19.75 12,19.75 C12,19.75 18.59,19.75 19.976,19.422 C20.767,19.186 21.347,18.606 21.582,17.814 C21.917,16.428 21.917,12 21.917,12 C21.917,12 21.917,7.572 21.582,6.186 Z M10,15.25 L10,8.75 L15,12 L10,15.25 Z"></path></svg>
);
